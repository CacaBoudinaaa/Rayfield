...
local AuthorizedHWIDs = {
    "F255E76D134DBEE32389B5FA17B3F99A707580A42B0966CABA0B3201FB1FBB0D", -- Owner (badol) - Your PC
...
local Window = Rayfield:CreateWindow({
   Name = "Essence | Rivals",
   Icon = 119846787915770, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
...
local function enable4KGraphics()
   pcall(function()
      ...
      Lighting.ExposureCompensation = 0.10 -- Exposition réduite
